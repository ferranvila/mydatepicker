...
var MyDatePicker = (function () {
    function MyDatePicker(elem, renderer, cdr, localeService, utilService) {
        ...
        renderer.listenGlobal("document", "click", function (event) {
            if (_this.showSelector && event.target && _this.selectorEl && _this.selectionGroupEl &&
                _this.elem.nativeElement !== event.target &&
                !_this.selectorEl.nativeElement.contains(event.target) &&
                !_this.selectionGroupEl.nativeElement.contains(event.target)) {
    ...
    MyDatePicker.prototype.openBtnClicked = function () {
        ...
        if (this.showSelector) {
            ...
            var inputBounding = this.inputBoxEl.nativeElement.getBoundingClientRect();
    ...
    MyDatePicker.propDecorators = {
        ...
        'selectionGroupEl': [{ type: _angular_core.ViewChild, args: ["selectionGroupEl",] },],
    };
    return MyDatePicker;
}());
